...
<tr><td><input type="button" class="BigButton" onclick="javascript:GB_showCenter('新增地区品牌责任人','${ctx}/system/area-app!input.action',300, 800);" value="新增地区品牌责任人" /></td></tr>
</table>
<table class="TableList"  width="98%" align="center">
  ...
  <tr class="TableLine1">
    ...
    <a href="javascript:if(confirm('确认删除此责任人么？'))document.location.href='area-app!delete.action?id=${id}';" title="删除地区"><s:text name='common.delete'/></a>    </td>
  </tr>
</s:iterator>
</table>

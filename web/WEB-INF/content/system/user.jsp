...
<tr><td><input type="button" class="BigButton" onclick="javascript:GB_showCenter('<s:text name='common.add'/><s:text name='user.user'/>','${ctx}/system/user!input.action',330, 800);" value="<s:text name='common.add'/><s:text name='user.user'/>" /></td></tr>
</table>
<table class="TableList"  width="98%" align="center">
  ...
  <tr class="TableLine1">
    ...
    <a href="user!input.action?id=${id}" rel="gb_page_center[800, 330]" title="<s:text name='common.edit'/><s:text name='user.user'/>"><s:text name='common.edit'/></a>
    <a href="javascript:if(confirm('<s:text name='user.confirm_delete'/>'))document.location.href='user!delete.action?id=${id}';" title="<s:text name='common.delete'/><s:text name='user.user'/>"><s:text name='common.delete'/></a>    </td>
  </tr>
</s:iterator>
</table>

...
<table align="center" width="99%" class="TableBlock">
  ...
  <tr>
      ...
      <td width="40%" align="left" class="TableData"><input type="text" class="BigInput" name="id" id="id" size="20" maxlength="50" value="${id}" /></td>
  </tr>
  <tr>
      <td width="10%" align="right" nowrap="nowrap" class="TableContent">地区名称</td>
      <td width="40%" align="left" class="TableData"><input type="text" class="BigInput" name="name" id="name" size="20" maxlength="50" value="${name}" /></td>
  </tr>

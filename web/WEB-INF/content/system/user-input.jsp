...
<table align="center" width="99%" class="TableBlock">
  ...
  <tr>
      ...
      <td width="40%" align="left" class="TableData"><input type="text" class="BigInput" name="loginName" id="loginName" size="20" maxlength="50" value="${loginName}" <s:if test="id != null">readonly='readonly'</s:if> /></td>
      <td width="10%" align="right" nowrap="nowrap" class="TableContent"><s:text name='user.shortName'/></td>
      <td width="40%" align="left" class="TableData"><input name="shortName" type="text" class="BigInput" id="shortName" value="${shortName}" size="20" maxlength="50" /></td>
  </tr>
  <tr>
    <td align="right" nowrap="nowrap" class="TableContent"><s:text name='user.plainPassword'/></td>
    <td align="left" class="TableData"><input type="password" class="BigInput" name="plainPassword" id="plainPassword" size="20" maxlength="50" value="${plainPassword}" /></td>
    <td align="right" nowrap="nowrap" class="TableContent"><s:text name='user.passwordConfirm'/></td>
    <td align="left" class="TableData"><input name="passwordConfirm" type="password" class="BigInput" id="passwordConfirm" value="${plainPassword}" size="20" maxlength="50" /></td>
  </tr>
  <tr>
      <td nowrap="nowrap" class="TableContent" align="right"><s:text name='user.name'/></td>
      <td align="left" class="TableData"><input name="name" type="text" class="BigInput" id="name" value="${name}" size="20" maxlength="50" /></td>
      <td nowrap="nowrap" class="TableContent" align="right"><s:text name='user.englishName'/></td>
      <td align="left" class="TableData"><input name="englishName" type="text" class="BigInput" id="englishName" value="${englishName}" size="20" maxlength="50" /></td>
  </tr>
  <tr>
    <td nowrap="nowrap" class="TableContent" align="right">所属区域</td>
    <td align="left" class="TableData"><s:select name="area_id" headerKey="" headerValue="请选择" list="areasAll" listKey="id" listValue="name" /></td>
    <td align="right" nowrap="nowrap" class="TableContent"><s:text name='user.email'/></td>
    <td align="left" class="TableData"><input name="email" type="text" class="BigInput" id="email" value="${email}" size="20" maxlength="50" /></td>
  </tr>
  <tr>
    <td nowrap="nowrap" class="TableContent" align="right">区域销售经理</td>
    <td align="left" class="TableData"><s:select name="asm_id" headerKey="" headerValue="请选择" list="asmsAll" listKey="id" listValue="name" /></td>
  ...
  <tr>
      <td colspan="4" class="TableData"><s:radio name="checkedRoles" list="rolesAll" listKey="id" listValue="name" /></td>
    </tr>

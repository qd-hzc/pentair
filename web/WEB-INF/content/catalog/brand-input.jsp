...
<form id="inputForm" action="${ctx}/catalog/brand!save.action" method="post">
    ...
    <table align="center" width="99%" class="TableBlock">
        ...
        <tr>
            ...
            <td width="40%" align="left" class="TableData"><input type="text" class="BigInput" name="code" id="code"
                                                                  size="30" maxlength="50" value="${code}"/></td>
            <td width="10%" align="right" nowrap="nowrap" class="TableContent">名称</td>
            <td width="40%" align="left" class="TableData">
                <input type="text" class="BigInput" name="name" id="name" size="30" maxlength="50" value="${name}"/>
            </td>
        </tr>
        <tr>
            <td nowrap="nowrap" class="TableContent" align="right">应用工程部经理</td>
            <td align="left" class="TableData"><s:select name="am_id" headerKey="" headerValue="请选择" list="usersAll"
                                                         listKey="id" listValue="name"/></td>
            <td nowrap="nowrap" class="TableContent" align="right">报价工程部经理</td>
            <td align="left" class="TableData"><s:select name="cm_id" headerKey="" headerValue="请选择" list="usersAll"
                                                         listKey="id" listValue="name"/></td>
        </tr>
        <tr>
            <td align="right" nowrap="nowrap" class="TableContent">客户服务部经理</td>
            <td align="left" class="TableData"><s:select name="csm_id" headerKey="" headerValue="请选择" list="usersAll"
                                                         listKey="id" listValue="name"/></td>
            <td align="right" nowrap="nowrap" class="TableContent">市场部经理</td>
            <td align="left" class="TableData"><s:select name="mm_id" headerKey="" headerValue="请选择" list="usersAll"
                                                         listKey="id" listValue="name"/></td>
        </tr>
        <tr>
            <td nowrap="nowrap" class="TableContent" align="right">销售总监</td>
            <td align="left" class="TableData"><s:select name="md_id" headerKey="" headerValue="请选择" list="usersAll"
                                                         listKey="id" listValue="name"/></td>
            <td align="right" nowrap="nowrap" class="TableContent">总经理</td>
            <td align="left" class="TableData"><s:select name="gm_id" headerKey="" headerValue="请选择" list="usersAll"
                                                         listKey="id" listValue="name"/></td>
        </tr>

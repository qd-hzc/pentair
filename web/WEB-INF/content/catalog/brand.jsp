...
<tr><td><input type="button" class="BigButton" onClick="javascript:GB_showCenter('<s:text name='common.add'/>品牌','${ctx}/catalog/brand!input.action',300, 800);" value="<s:text name='common.add'/>品牌" /></td></tr>
</table>
...
<table class="TableList"  width="98%" align="center">
  ...
  <tr class="TableLine1">
    ...
    <a href="brand!input.action?id=${id}" rel="gb_page_center[800, 300]" title="<s:text name='common.edit'/>品牌"><s:text name='common.edit'/></a>
    <a href="javascript:if(confirm('确定要删除该品牌吗？'))document.location.href='brand!delete.action?id=${id}';" title="<s:text name='common.delete'/>品牌"><s:text name='common.delete'/></a>&nbsp;</td>
  </tr>
</s:iterator>
  <tr class="TableLine1">

...
<table width="98%" align="center">
    <tr>
        <td><input type="button" class="BigButton" onClick="javascript:GB_showCenter('<s:text
                name='common.add'/>产品','${ctx}/catalog/product!input.action',250, 500);"
                   value="<s:text name='common.add'/>产品"/></td>
    </tr>
</table>
        ...
        <s:iterator value="page.result">
            <tr class="TableLine1">
                ...
                <td align="center" nowrap>
                    <a href="product!input.action?id=${id}" rel="gb_page_center[500, 250]"
                       title="<s:text name='common.edit'/>产品"><s:text name='common.edit'/></a>
                    <a href="javascript:if(confirm('确定要删除该产品吗？'))document.location.href='product!delete.action?id=${id}';"
                       title="<s:text name='common.delete'/>产品"><s:text name='common.delete'/></a></td>
            </tr>
        </s:iterator>
        <tr class="TableLine1">
            <td colspan="5" align="center" class="TableControl">

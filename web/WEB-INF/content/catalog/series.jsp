...
<tr><td><input type="button" class="BigButton" onClick="javascript:GB_showCenter('<s:text name='common.add'/>产品系列','${ctx}/catalog/series!input.action',250, 500);" value="<s:text name='common.add'/>产品系列" /></td></tr>
</table>
...
<table class="TableList"  width="98%" align="center">
  ...
  <tr class="TableLine1">
    ...
    <a href="series!input.action?id=${id}" rel="gb_page_center[550, 350]" title="<s:text name='common.edit'/>产品系列"><s:text name='common.edit'/></a>
    <a href="javascript:if(confirm('确定要删除该产品系列吗？'))document.location.href='series!delete.action?id=${id}';" title="<s:text name='common.delete'/>产品系列"><s:text name='common.delete'/></a>&nbsp;</td>
  </tr>
</s:iterator>
  <tr class="TableLine1">
    <td colspan="9" align="center" class="TableControl"><%@ include file="/common/pager.jsp" %></td>
    </tr>
</table>
</form>

...
<table width="98%" align="center">
    <tr>
        <td><input type="button" class="BigButton" onClick="javascript:GB_showCenter('<s:text
                name='common.add'/>编码规则','${ctx}/catalog/snrule!input.action',500, 900);"
                   value="<s:text name='common.add'/>编码规则"/></td>
    </tr>
</table>
        ...
        <s:iterator value="page.result">
            <tr class="TableLine1">
                ...
                <td align="center" nowrap>
                    <a href="snrule!input.action?id=${id}" rel="gb_page_center[900, 500]"
                       title="<s:text name='common.edit'/>编码规则"><s:text name='common.edit'/></a>
                    <a href="javascript:if(confirm('确定要删除该编码规则吗？'))document.location.href='snrule!delete.action?id=${id}';"
                       title="<s:text name='common.delete'/>编码规则"><s:text name='common.delete'/></a>&nbsp;</td>
            </tr>
        </s:iterator>
        <tr class="TableLine1">
            <td colspan="12" align="center" class="TableControl">

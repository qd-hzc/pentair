...
<div id="uploading3">
    <form name="uploadForm" id="uploadForm" action="/upload/file-upload!upload.action" method="post"
        ...
        <s:iterator value="fileUploads">
            &nbsp;&nbsp;&nbsp;&nbsp;<a href="${ctx}/upload/file-upload.action?id=<s:property value='id'/>"><s:property
                value="fileSaveName"/></a>
            <a href="javascript:deleteFile('<s:property value='id'/>');"><img src="${ctx}/img/delete2.gif" border="0"
                                                                              title="删除附件"/></a>
        </s:iterator>
    </form>
</div>

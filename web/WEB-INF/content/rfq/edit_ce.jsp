...
<table align="center" width="970" class="TableBlock">
  <tr>
    <td colspan="4" nowrap="nowrap" class="TableHeader">信息必须填写完整，该信息将作为报价的依据</td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="4" align="right" class="TableData"><table width="100%" border="0">
      ...
      <tr class="${specialPrice!=null && specialPrice!='' ? 'specialTr' : ''}">
        ...
        <%--td>${expectedPrice}&nbsp;</td--%>
        <td><fmt:formatNumber value="${materialCost}" pattern="#.##"  groupingUsed="true"/>&nbsp;</td>
        ...
        <td><fmt:formatNumber value="${series.targetProfit}" pattern="#.##"  groupingUsed="true"/>%</td>
        <td><fmt:formatNumber value="${series.discountRate}" pattern="#.##"  groupingUsed="true"/>%</td>
        ...
        <td align="center"><a href="rfq-detail!input.action?id=${id}&prefix=${series.shortName}"><s:text name='common.edit'/></a></td>
      </tr>
      </s:iterator>
    </table></td>
    </tr>
  ...
  <tr>
    ...
    <td colspan="3" align="left" class="TableData"><textarea name="noteCePublic" id="noteCePublic" cols="70" rows="2">${noteCePublic}</textarea>
    <iframe id="upload3" src="${ctx}/upload/file-upload!init.action?dir1=${sn}&dir2=cePublic&dir3=" frameborder="0" scrolling="no" width="600" height="50"></iframe></td>
  </tr>
  <%--tr>
    <td width="15%" align="right" nowrap="nowrap" class="TableContent"><strong>报价工程部意见(成本)</strong></td>
    <td width="150" colspan="3" align="left" class="TableData"><textarea name="noteCe" id="noteCe" cols="70" rows="5">${noteCe}</textarea>
    <iframe id="upload3" src="${ctx}/upload/file-upload!init.action?dir1=${sn}&dir2=ce&dir3=" frameborder="0" scrolling="no" width="600" height="50"></iframe></td>
    </tr--%>
  <tr>
    <td class="TableData" height="50" colspan="4" align="center">
...
window.setInterval("reinitIframe('upload3')", 200);

...
<form id="inputForm" action="${ctx}/rfq/rfq!save.action" method="post">
    ...
    <table align="center" width="970" class="TableBlock">
        ...
        <tr>
            ...
            <td colspan="3" align="left" class="TableData"><textarea name="noteCePublic" id="noteCePublic" cols="70"
                                                                     rows="2">${noteCePublic}</textarea>
                <iframe id="upload3" src="${ctx}/upload/file-upload!init.action?dir1=${sn}&dir2=cePublic&dir3="
        ...
        <tr>
            <td class="TableData" height="50" colspan="4" align="center">
                ...
                <s:if test="status.id=='cm2ce'">
                    <s:select name="ce_id" headerKey="" headerValue="请选择" list="cEUsersAll" listKey="id"
                              listValue="name"/>
                </s:if>
            </td>
        </tr>

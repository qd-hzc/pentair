...
<table align="center" width="99%" class="TableBlock">
  ...
  <tr>
    ...
    <td colspan="3" align="left" class="TableData"><input type="text" class="BigInput" name="productName" id="productName" size="30" maxlength="50" value="${productName}"/></td>
  </tr>
  <tr>
    <td align="right" nowrap="nowrap" class="TableContent">竞争对手名称</td>
    <td width="35%" align="left" class="TableData"><input name="competitorName" type="text" class="BigInput" id="competitorName" value="${competitorName}" size="30" maxlength="50" /></td>
    <td width="15%" align="right" class="TableContent">竞争对手价格</td>
    <td align="left" class="TableData"><input name="competitorPrice" type="text" class="BigInput" id="competitorPrice" value="${competitorPrice}" size="30" maxlength="50" /></td>
  </tr>
  <tr>
    <td align="right" nowrap="nowrap" class="TableContent">目标价位</td>
    <td align="left" class="TableData"><input name="expectedPrice" type="text" class="BigInput" id="expectedPrice" value="${expectedPrice}" size="30" maxlength="50" /></td>
    <td align="right" class="TableContent">代理商预留利润</td>
    <td align="left" class="TableData"><input name="agentProfit" type="text" class="BigInput" id="agentProfit" value="${agentProfit}" size="30" maxlength="50" /></td>
  </tr>
  <tr>
    <td align="right" nowrap="nowrap" class="TableContent">客户要求交货周期</td>
    <td align="left" class="TableData"><input name="deliveryCycle" type="text" class="BigInput" id="deliveryCycle" value="${deliveryCycle}" size="30" maxlength="50" /></td>
    <td align="right" class="TableContent">销售机会</td>
    <td align="left" class="TableData"><input name="opportunity" type="text" class="BigInput" id="opportunity" value="${opportunity}" size="30" maxlength="50" /></td>
  </tr>
  <tr>
    <td nowrap="nowrap" class="TableContent" align="right">年需求量(台/套)</td>
    <td align="left" class="TableData"><input name="quantityYear" type="text" class="BigInput" id="quantityYear" value="${quantityYear}" size="30" maxlength="50" /></td>
    <td align="right" class="TableContent">每单最小批量(台/套)</td>
    <td align="left" class="TableData"><input name="quantityMin" type="text" class="BigInput" id="quantityMin" value="${quantityMin}" size="30" maxlength="50" /></td>
  </tr>
  <tr>
    <td nowrap="nowrap" class="TableContent" align="right">年销售额(万元)</td>
    <td align="left" class="TableData" colspan=3><input name="saleAmountYear" type="text" class="BigInput" id="saleAmountYear" value="${saleAmountYear}" size="30" maxlength="50" /></td>
  </tr>
  <security:authorize ifAnyGranted="ROLE_CM,ROLE_CE,ROLE_ADMIN">
  <tr>
    <td nowrap="nowrap" class="TableContent" align="right">材料费</td>
    <td align="left" class="TableData"><input name="materialCost" type="text" class="BigInput" id="materialCost" value="${materialCost}" size="30" maxlength="50" /></td>
    <td align="right" class="TableContent">工时费</td>
    <td align="left" class="TableData"><input name="loh" type="text" class="BigInput" id="loh" value="${loh}" size="30" maxlength="50" /></td>
  </tr>
  </security:authorize>
  <security:authorize ifAnyGranted="ROLE_CM,ROLE_CE,ROLE_ADMIN">
  <tr>
    <td nowrap="nowrap" class="TableContent" align="right">工装模具费</td>
    <td align="left" class="TableData"><input name="toolingCharge" type="text" class="BigInput" id="toolingCharge" value="${toolingCharge}" size="30" maxlength="50" /></td>
    <td align="right" class="TableContent">批量</td>
    <td align="left" class="TableData"><input name="batch" type="text" class="BigInput" id="batch" value="${batch}" size="30" maxlength="50" /></td>
  </tr>
  <tr>
    <td nowrap="nowrap" class="TableContent" align="right">交货周期<br>(weeks)</td>
    <td align="left" class="TableData"><input name="deliveryWeeks" type="text" class="BigInput" id="deliveryWeeks" value="${deliveryWeeks}" size="30" maxlength="45" /></td>
  ...
  <tr>
    ...
    <td colspan="3" align="left" class="TableData"><iframe id="upload1" src="${ctx}/upload/file-upload!init.action?dir1=${rfq_sn}&dir2=${sn.replaceAll('&', '_')}&dir3=tech" frameborder="0" scrolling="no" width="600" height="50"></iframe></td>
  </tr>
  <tr>
    <td nowrap="nowrap" class="TableContent" align="right">配置清单</td>
    <td colspan="3" align="left" class="TableData"><iframe id="upload2" src="${ctx}/upload/file-upload!init.action?dir1=${rfq_sn}&dir2=${sn.replaceAll('&', '_')}&dir3=list" frameborder="0" scrolling="no" width="600" height="50"></iframe></td>
  </tr>
  <tr>

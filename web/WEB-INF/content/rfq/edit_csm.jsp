        ...
        <tr>
            <td class="TableData" height="50" colspan="4" align="center" nowrap>
                <s:iterator value="rfqWorkflows">
                    <s:if test="nextStatus.id=='cs2sales' && csBackCount == 0 || nextStatus.id!='cs2sales'">
                ...
                <s:select name="cs_id" headerKey="" headerValue="请选择" list="cSUsersAll" listKey="id" listValue="name"/>
            </td>
        </tr>
    </table>
</form>

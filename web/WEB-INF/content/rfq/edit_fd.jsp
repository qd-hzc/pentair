...
<table align="center" width="99%" class="TableBlock">
  ...
  <tr>
    <td colspan="4" align="right" class="TableData"><table width="100%" border="0">
      ...
      <tr class="${specialPrice!=null && specialPrice!='' ? 'specialTr' : ''}">
        ...
        <td align="center"><a href="rfq-detail!view.action?id=${id}"><s:text name='common.view'/></a></td>
      </tr>
      </s:iterator>
    </table></td>
    </tr>
  ...
  <tr>
    ...
    <td colspan="3" align="left" class="TableData"><textarea name="noteFd" id="noteFd" cols="70" rows="3">${noteFd}</textarea></td>
  </tr>
  <tr>

...
<form id="inputForm" action="${ctx}/rfq/rfq!save.action" method="post">
    ...
    <table align="center" width="99%" class="TableBlock">
        ...
        <tr>
            ...
            <td colspan="3" align="left" class="TableData"><textarea name="notePm" id="notePm" cols="70"
                                                                     rows="3">${notePm}</textarea>
                <iframe id="upload3" src="${ctx}/upload/file-upload!init.action?dir1=${sn}&dir2=pm&dir3="
                        frameborder="0" scrolling="no" width="600" height="50"></iframe>
            </td>
        </tr>

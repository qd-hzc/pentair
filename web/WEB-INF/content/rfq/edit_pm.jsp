...
<table align="center" width="99%" class="TableBlock">
  ...
  <tr>
    ...
    <td colspan="3" align="left" class="TableData"><textarea name="noteProfit" id="noteProfit" cols="70" rows="4">${noteProfit}</textarea></td>
  </tr>
  </s:if>
  <tr>
    <td nowrap="nowrap" class="TableContent" align="right"><strong>产品经理意见</strong></td>
    <td colspan="3" align="left" class="TableData"><textarea name="notePm" id="notePm" cols="70" rows="3">${notePm}</textarea>
    <iframe id="upload3" src="${ctx}/upload/file-upload!init.action?dir1=${sn}&dir2=pm&dir3=" frameborder="0" scrolling="no" width="600" height="50"></iframe></td>
  </tr>
  ...
  <tr>
    <td class="TableData" height="50" colspan="4" align="center" nowrap>
      ...
      <input type="submit" class="BigButton" value="${title}" onClick="javascript:document.getElementById('rfqStatus').value='${nextStatus.id}';return window.confirm('确认要提交吗？');" />&nbsp;&nbsp;&nbsp;&nbsp;    </s:iterator>    </td>
  </tr>
</table>
</form>
<s:iterator value="rfqDetails">

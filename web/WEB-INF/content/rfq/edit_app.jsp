    ...
    <table align="center" width="99%" class="TableBlock">
        ...
        <tr>
            ...
            <td colspan="3" align="left" class="TableData">
                ...
                <s:select name="appCheck4" headerKey="" headerValue="请选择"
                          list="#{'50%':'50%','70%':'70%','80%以上':'80%以上'}"/>
            </td>
        </tr>
        ...
        <tr>
            <td class="TableData" height="50" colspan="4" align="center" nowrap>
                ...
                <s:if test="status.id == 'am2app'">
                    <s:select name="app_id" headerKey="" headerValue="请选择" list="aPPUsersAll" listKey="id"
                              listValue="name"/>
                </s:if>
            </td>
        </tr>

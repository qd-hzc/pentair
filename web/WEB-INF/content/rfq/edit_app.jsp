...
<table align="center" width="99%" class="TableBlock">
  ...
  <tr>
    <td colspan="4" nowrap="nowrap" class="TableControl"><strong>产品信息</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" class="SmallButton" onClick="javascript:location='rfq-detail!input.action?rfq_id=${id}&prefix=' + window.prefix;" value="新增产品信息" /></td>
    </tr>
  <tr>
    <td colspan="4" align="right" class="TableData"><table width="100%" border="0">
      ...
      <tr class="${specialPrice!=null && specialPrice!='' ? 'specialTr' : ''}">
        ...
        <td align="center"><a href="rfq-detail!input.action?id=${id}&prefix=${series.shortName}"><s:text name='common.edit'/></a>        
          <a href="javascript:if(confirm('确定要删除该产品信息吗？'))document.location.href='rfq-detail!delete.action?id=${id}';"><s:text name='common.delete'/></a>        </td>
      </tr>
      </s:iterator>
    </table></td>
    </tr>
   <tr>
<td nowrap="nowrap" class="TableContent" align="right">应用工程部意见</td>
    <td colspan="3" align="left" class="TableData">
      <textarea name="noteApp" id="noteApp" cols="70" rows="5">${noteApp}</textarea>    
    <br />
    <s:checkbox name="appCheck1" />项目基本信息填写完整&nbsp;
    <s:checkbox name="appCheck2" />技术说明完善&nbsp;
    <s:checkbox name="appCheck3" />配置清单完善，与标准产品的契合度：
    <s:select name="appCheck4" headerKey="" headerValue="请选择" list="#{'50%':'50%','70%':'70%','80%以上':'80%以上'}" />    
    </td></tr>
  ...
  <tr>
   ...
   <tr>
     <td nowrap="nowrap" class="TableContent" align="right">产品经理意见</td>
     <td colspan="3" align="left" class="TableData">${notePm}</td>
   </tr>
   </s:if>
  <%--
  ...
  <tr>
    ...
    <s:if test="status.id == 'am2app'">
    <s:select name="app_id" headerKey="" headerValue="请选择" list="aPPUsersAll" listKey="id" listValue="name" />
    </s:if>
    </td>
  </tr>
</table>

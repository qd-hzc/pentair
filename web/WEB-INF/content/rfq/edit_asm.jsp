    ...
    <table align="center" width="99%" class="TableBlock">
                ...
                <table width="100%" border="0">
                    ...
                    <s:iterator value="rfqDetails">
                        <tr class="${specialPrice!=null && specialPrice!='' ? 'specialTr' : ''}">
                            ...
                            <s:if test="status.id=='specialprice2asm'">
                                <td><input type=text size=10 name="specialPrice" class="specialPrice"
                                           value="${specialPrice}"></td>
        ...
        <s:if test="status.id == 'specialprice2asm'">
            <tr>
                ...
                <td colspan="3" align="left" class="TableData"><textarea name="noteSpecialPrice" id="noteSpecialPrice"
                                                                         cols="70"
                                                                         rows="4">${noteSpecialPrice}</textarea>
                    <iframe id="upload3" src="${ctx}/upload/file-upload!init.action?dir1=${sn}&dir2=specialPrice&dir3="
            ...
            <tr>
                ...
                <td colspan="3" align="left" class="TableData"><textarea name="noteProfit" id="noteProfit" cols="70"
                                                                         rows="4">${noteProfit}</textarea></td>
            </tr>
        </s:if>
        ...
        <tr>
            <td class="TableData" height="50" colspan="4" align="center" nowrap>
                <s:iterator value="rfqWorkflows">
                    <s:if test="nextStatus.id == 'asm2salesyes' || nextStatus.id == 'asm2pm'">
                        <input type="submit" class="BigButton" value="${title}"
                               onClick="javascript:document.getElementById('rfqStatus').value='${nextStatus.id}';return checkSpecialPrice();"/>&nbsp;&nbsp;&nbsp;&nbsp;
                    </s:if>
                    <s:if test="nextStatus.id == 'asm2salesno'">
                        <input type="submit" class="BigButton" value="${title}"

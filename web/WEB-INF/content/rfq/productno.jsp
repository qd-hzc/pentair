...
<table align="center" width="99%" class="TableBlock">
	<tr>
		...
		<td class="TableContent"><s:select style="width:400px;" id="snRules" name="snRules" headerKey="" headerValue="请选择" list="snRulesAll" listKey="id" listValue="name" onchange="snRuleChange(this);"/></td>
	</tr>
</table>
<table align="center" width="99%" class="TableBlock" style='table-layout:auto'>
	...
	<tr>
		<td class="TableData" align=center valign=top><input type=text id=d1 maxlength=2 style='width:40px' onblur='this.value=this.value.toUpperCase();'/></td>
		<td class="TableData" align=center valign=top><input type=text id=d2 maxlength=2 style='width:40px' onblur='this.value=this.value.toUpperCase();'/></td>
		<td class="TableData" align=center valign=top><input type=text id=d3 maxlength=2 style='width:40px' onblur='this.value=this.value.toUpperCase();'/></td>
		<td class="TableData" align=center valign=top><input type=text id=d4 maxlength=2 style='width:40px' onblur='this.value=this.value.toUpperCase();'/></td>
		<td class="TableData" align=center valign=top><input type=text id=d5 maxlength=1 style='width:40px' onblur='this.value=this.value.toUpperCase();'/></td>
		<td class="TableData" align=center valign=top><input type=text id=d6 maxlength=1 style='width:40px' onblur='this.value=this.value.toUpperCase();'/></td>
		<td class="TableData" align=center valign=top><input type=text id=d7 maxlength=1 style='width:40px' onblur='this.value=this.value.toUpperCase();'/></td>
		<td class="TableData" align=center valign=top><input type=text id=d8 maxlength=1 style='width:40px' onblur='this.value=this.value.toUpperCase();'/></td>
		<td class="TableData" align=center valign=top><input type=text id=d9 maxlength=1 style='width:40px'/></td>
		<td class="TableData" align=center valign=top><input type=text id=d10 maxlength=4 style='width:40px' onblur='this.value=this.value.toUpperCase();' readonly/></td>
	</tr>
	<tr>

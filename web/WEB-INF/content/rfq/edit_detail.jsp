...
<table align="center" width="99%" class="TableBlock">
  ...
  <tr>
    ...
    <td width="35%" align="left" class="TableData"><input type="text" class="BigInput" name="competitorName" id="competitorName" size="30" maxlength="50" /></td>
    <td width="15%" align="right" class="TableContent">竞争对手价格</td>
    <td align="left" class="TableData"><input type="text" class="BigInput" name="competitorPrice" id="competitorPrice" size="30" maxlength="50" /></td>
  </tr>
  <tr>
    <td align="right" nowrap="nowrap" class="TableContent">目标价位</td>
    <td align="left" class="TableData"><input type="text" class="BigInput" name="expectedPrice" id="expectedPrice" size="30" maxlength="50" /></td>
    <td align="right" class="TableContent">代理商预留利润</td>
    <td align="left" class="TableData"><input type="text" class="BigInput" name="agentProfit" id="agentProfit" size="30" maxlength="50" /></td>
  </tr>
  <tr>
    <td align="right" nowrap="nowrap" class="TableContent">客户要求交货周期</td>
    <td align="left" class="TableData"><input type="text" class="BigInput" name="deliveryCycle" id="deliveryCycle" size="30" maxlength="50" /></td>
    <td align="right" class="TableContent">销售机会</td>
    <td align="left" class="TableData"><input type="text" class="BigInput" name="opportunity" id="opportunity" size="30" maxlength="50" /></td>
  </tr>
  <tr>
    <td nowrap="nowrap" class="TableContent" align="right">年需求量(台/套)</td>
    <td align="left" class="TableData"><input type="text" class="BigInput" name="quantityYear" id="quantityYear" size="30" maxlength="50" /></td>
    <td align="right" class="TableContent">每单最小批量(台/套)</td>
    <td align="left" class="TableData"><input type="text" class="BigInput" name="quantityMin" id="quantityMin" size="30" maxlength="50" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="3" align="left" class="TableData"><iframe id="upload1" src="${ctx}/upload/file-upload!init.action?dir1=${rfq_sn}&dir2=${rfqDetail_sn.replaceAll('&', '_')}&dir3=tech" frameborder="0" scrolling="no" width="600" height="50"></iframe></td>
  </tr>
  <tr>
    <td nowrap="nowrap" class="TableContent" align="right">配置清单</td>
    <td colspan="3" align="left" class="TableData"><iframe id="upload2" src="${ctx}/upload/file-upload!init.action?dir1=${rfq_sn}&dir2=${rfqDetail_sn.replaceAll('&', '_')}&dir3=list" frameborder="0" scrolling="no" width="600" height="50"></iframe></iframe></td>
  </tr>
  <tr>
    <td class="TableData" height="50" colspan="4" align="center" nowrap>
    <input name="提交" type="submit" class="BigButton" value="保存，填写其它产品信息" />&nbsp;&nbsp;&nbsp;&nbsp;
      <input type="submit" class="BigButton" value="保存，提交至应用工程部" onclick="javascript:document.getElementById('status').value='sales2am';" />
      &nbsp;&nbsp;&nbsp;&nbsp;
      <input type="submit" class="BigButton" value="保存，暂不提交" onclick="javascript:document.getElementById('status').value='input';" /></td>
  </tr>
</table>
</form>
</body>

...
<table align="center" width="99%" class="TableBlock">
  ...
  <tr>
    ...
    <td align="left" class="TableData"><input type="text" class="BigInput" name="customerName" id="customerName" size="30" maxlength="50" value="${customerName}" /></td>
    </tr>
  <tr>
    <td nowrap="nowrap" class="TableContent" align="right">产品系列</td>
    <td align="left" class="TableData"><s:select name="series_id" headerKey="" onchange='seriesChange(this);' headerValue="请选择" list="seriesAll" listKey="id" listValue="name" /></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="4" nowrap="nowrap" class="TableControl"><strong>产品信息</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" class="BigButton" onClick="javascript:location='rfq-detail!input.action?rfq_id=${id}&prefix=' + window.prefix;" value="新增产品信息" /></td>
    </tr>
  <tr>
    <td colspan="4" align="right" class="TableData"><table width="100%" border="0">
      ...
      <tr>
        ...
        <td align="center"><a href="rfq-detail!input.action?id=${id}&prefix=${series.shortName}"><s:text name='common.edit'/></a>        
          <a href="javascript:if(confirm('确定要删除该产品信息吗？'))document.location.href='rfq-detail!delete.action?id=${id}';"><s:text name='common.delete'/></a>
        </td>
      </tr>
      </s:iterator>
    </table></td>
  ...
  <tr>
    ...
    <input type="submit" class="BigButton" value="保存" onclick="javascript:document.getElementById('rfqStatus').value='csinput';" />
    </td>
  </tr>
</table>
</form>

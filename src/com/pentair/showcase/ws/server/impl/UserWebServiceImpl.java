...
import com.pentair.showcase.ws.server.UserWebService;
import com.pentair.showcase.ws.server.WsConstants;
import com.pentair.showcase.ws.server.dto.UserDTO;
import com.pentair.showcase.ws.server.result.GetAllUserResult;
import com.pentair.showcase.ws.server.result.GetUserResult;
...
@WebService(serviceName = "UserService", portName = "UserServicePort", endpointInterface = "com.pentair.showcase.ws.server.UserWebService", targetNamespace = WsConstants.NS)
